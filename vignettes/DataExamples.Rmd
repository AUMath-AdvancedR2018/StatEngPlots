...
The normal probability plot is a graphical technique for assessing whether or not a dataset is approximately normally distributed.The points of the temperatures form a nearly nice pattern in both Istanbul and Copenhagen which indicates that the normal distribution is a good model for this data set. 
...
Again in both countries temperatures are random so there is no way of knowing what the temperature will be from one month before.

Histogram :

Histogram shows nicely the repeated temperatures for both countries.

Normal Probability Plot:

In both countries the temperatures are nearly linearly distributed. So the normal distribution is a good model for this dataset.
