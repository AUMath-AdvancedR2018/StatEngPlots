...
We have included two datasets which are showing some mean temperatures for every day in 2015 in Copenhagen and Istanbul. The temperatures are specified in Fahrenheit. You can use the datasets by calling TempCop for Copenhagen and TempIst for Istanbul.
